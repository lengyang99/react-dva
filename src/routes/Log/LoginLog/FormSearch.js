  ...
  render() {
    ...
    return (
      ...
      >
        <Row gutter={10}>
          <Col span={5} >
            <FormItem {...formItemLayout} style={{ marginBottom: 0 }} label="用户">
          ...
          <Col span={5} >
            <FormItem {...formItemLayout} style={{ marginBottom: 0 }} label="操作">
          ...
          <Col span={5} >
            <FormItem {...formItemLayout} style={{ marginBottom: 0 }} label="系统">
